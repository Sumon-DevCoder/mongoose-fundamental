...
router.patch("/:courseId", (0, validateRequest_1.default)(course_validation_1.courseValidations.updateCourseValidationSchema), course_controller_1.CourseControllers.updateSingleCourse);
router.delete("/:courseId", course_controller_1.CourseControllers.deleteSingleCourse);
